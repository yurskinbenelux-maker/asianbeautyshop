...
const STRINGS: Record<Locale, Strings> = {
  EN: {
    ...
    lede: "It's been about six weeks since we sent your last order. If you've been using your products as part of a daily ritual, this is around the time most people start scraping the bottom of the bottle.",
  ...
  RU: {
    ...
    lede: "Прошло около шести недель с момента отправки заказа. Если вы используете средства как часть ежедневного ритуала, обычно к этому моменту флаконы подходят к концу.",
