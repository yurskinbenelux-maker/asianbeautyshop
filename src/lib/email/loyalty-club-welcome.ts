// ─────────────────────────────────────────────────────────────────────────
// "Welcome to Asian Beauty Shop Club" — fires once, on the first LoyaltyAccount
...
const STRINGS: Record<Locale, Strings> = {
  EN: {
    subject: "Welcome to the Asian Beauty Shop Club",
    preheader: "A small thank-you for being here.",
    heading: (f) => (f ? `Welcome, ${f}.` : "Welcome."),
    intro:
      "You're now part of the Asian Beauty Shop Club — our quiet way of saying thank you, in points you can spend on the products that suit your skin.",
    bullets: [
    ...
    cta: "Open the Asian Beauty Shop Club",
    signoff: "With care,\nThe Asian Beauty Shop team",
    footer: "K'Elmus Group BV · Aartselaar, Belgium",
  },
  NL: {
    subject: "Welkom bij de Asian Beauty Shop Club",
    preheader: "Een klein bedankje dat je hier bent.",
    heading: (f) => (f ? `Welkom, ${f}.` : "Welkom."),
    intro:
      "Je maakt nu deel uit van de Asian Beauty Shop Club — onze stille manier van bedanken, in punten die je kunt uitgeven aan producten die bij je huid passen.",
    bullets: [
    ...
    cta: "Open de Asian Beauty Shop Club",
    signoff: "Met zorg,\nHet Asian Beauty Shop-team",
    footer: "K'Elmus Group BV · Aartselaar, België",
  },
  FR: {
    subject: "Bienvenue dans le Asian Beauty Shop Club",
    preheader: "Un petit merci d'être ici.",
    heading: (f) => (f ? `Bienvenue, ${f}.` : "Bienvenue."),
    intro:
      "Vous faites désormais partie du Asian Beauty Shop Club — notre manière discrète de dire merci, en points à dépenser sur les produits qui correspondent à votre peau.",
    bullets: [
    ...
    cta: "Ouvrir le Asian Beauty Shop Club",
    signoff: "Avec attention,\nL'équipe Asian Beauty Shop",
    footer: "K'Elmus Group BV · Aartselaar, Belgique",
  },
  RU: {
    subject: "Добро пожаловать в Asian Beauty Shop Club",
    preheader: "Маленькое спасибо за то, что вы с нами.",
    heading: (f) => (f ? `Добро пожаловать, ${f}.` : "Добро пожаловать."),
    intro:
      "Теперь вы — часть Asian Beauty Shop Club. Это наш тихий способ сказать «спасибо» — в виде баллов, которые можно тратить на средства, подходящие вашей коже.",
    bullets: [
    ...
    cta: "Открыть Asian Beauty Shop Club",
