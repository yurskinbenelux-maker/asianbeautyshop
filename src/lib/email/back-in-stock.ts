...
const STRINGS: Record<Locale, Strings> = {
  EN: {
    subject: (n) => `${n} is back — Asian Beauty Shop`,
  ...
  NL: {
    subject: (n) => `${n} is terug — Asian Beauty Shop`,
  ...
  FR: {
    subject: (n) => `${n} est de retour — Asian Beauty Shop`,
  ...
  RU: {
    subject: (n) => `${n} снова в наличии — Asian Beauty Shop`,
