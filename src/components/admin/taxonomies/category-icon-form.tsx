// ─────────────────────────────────────────────────────────────────────────
// CategoryIconForm — a minimal drag-drop / click uploader for the
// category icon. Posts a single file to uploadCategoryIconAction and
// optionally clears it via clearCategoryIconAction.
// ─────────────────────────────────────────────────────────────────────────
...
export function CategoryIconForm({
  categoryId,
  iconUrl,
}: {
  categoryId: string;
  ...
  const [state, action] = useActionState(uploadCategoryIconAction, INITIAL);
  ...
  return (
    <div className="flex flex-wrap items-center gap-6">
      {/* preview */}
      {iconUrl ? (
        <div className="relative h-20 w-20 border border-ink/10 bg-white">
